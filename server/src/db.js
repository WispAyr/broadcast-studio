...
function ensureModuleTypes() {
  const newTypes = [
    ...
    { name: 'match_stats', description: 'Match info/stats screens (view: header/form/players/group/road/facts/profile)', category: 'broadcast', icon: '📊',
      default_config: JSON.stringify({ view: 'header' }) },
    { name: 'scotland_hero', description: 'Scotland branding hero — animated saltire + tartan', category: 'broadcast', icon: '🏴󠁧󠁢󠁳󠁣󠁴󠁿',
      default_config: JSON.stringify({ title: 'SCOTLAND', subtitle: 'THE TARTAN ARMY', kicker: 'WORLD CUP 26' }) },
